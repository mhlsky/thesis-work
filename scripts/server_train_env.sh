...
export SHIP_MOTION_HW_PROFILE="${SHIP_MOTION_HW_PROFILE:-single_gpu_40g_12cpu_32g}"
export SHIP_MOTION_GPU_MEMORY_GB="${SHIP_MOTION_GPU_MEMORY_GB:-40}"
export SHIP_MOTION_CPU_CORES="${SHIP_MOTION_CPU_CORES:-12}"
export SHIP_MOTION_SYSTEM_MEMORY_GB="${SHIP_MOTION_SYSTEM_MEMORY_GB:-32}"
export SHIP_MOTION_PRECISION="${SHIP_MOTION_PRECISION:-auto}"

# 限制每个进程内部的 CPU 线程数，避免和 DataLoader worker 叠加后过度抢核。
